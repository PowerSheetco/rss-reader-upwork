...
When subscribing please enter the [email you will be using with PowerSheet](manual#which-email-should-i-use-to-subscribe-to-powersheet) (the address emails will be sent from).
