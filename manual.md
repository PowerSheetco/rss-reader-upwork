...
You can always change the [email you are sending from](#i-want-to-change-the-email-i-am-sending-from) and [receiving emails to](#i-want-to-change-the-email-i-am-receiving-notifications-to).
